...
{"headline":"short phrase naming the pattern","status_tag":"2-4 word pill","bars":[{"label":"behaviour dimension e.g. Effort balance","tag":"short qualifier","level":0,"tone":"good|caution|low","caption":"one observable detail, may weave an «exact quote»"}],"cards":[{"kind":"Pattern|What I'd watch","title":"short","body":"1-2 sentences, may weave «exact quotes»"}],"suggested_move":"one calm concrete next step","where_this_leaves_you":"grounding note; if healthy, say they can relax","safety":{"flag":false,"note":null},"receipts":[{"tag":"what it shows e.g. Pressed past a clear no","tone":"flag|neutral","messages":[{"speaker":"you|them","text":"EXACT verbatim message"}],"reads_as":"short line tying it to the read"}]}

Provide 2-4 bars and 2-3 cards, and 0-3 receipts. Each bar's "tone" must be one of good, caution, low. Each card's "kind" must be exactly "Pattern" or "What I'd watch". Each receipt "tone" must be "flag" or "neutral". Every point must tie to something observable in what the user shared.`;
