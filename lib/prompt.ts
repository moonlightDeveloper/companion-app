...
- CLOSED axis vocabulary — "axis" is ONE of exactly: "effort_balance", "plan_clarity", "reply_consistency". A moment that doesn't fit one of these is simply NOT emitted (that signal still lives in the read above). Never invent an axis name.
